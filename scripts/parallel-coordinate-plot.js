let allDimensions = [
    "sy_snum","sy_pnum","sy_mnum","disc_year","pl_orbper","pl_orbsmax","pl_rade","pl_bmasse","pl_bmassprov","pl_dens","pl_orbeccen","pl_insol","pl_eqt","pl_orbincl","pl_tranmid","pl_tsystemref","pl_imppar","pl_trandep","pl_trandur","pl_ratdor","pl_ratror","pl_occdep","pl_orbtper","pl_orblper","pl_rvamp","pl_projobliq","pl_trueobliq","st_refname","st_spectype","st_teff","st_rad","st_mass","st_met","st_metratio","st_lum","st_logg","st_age","st_dens","st_vsin","st_rotp","st_radv","sy_refname","rastr","ra","decstr","dec","glat","glon","elat","elon","sy_pm","sy_pmra","sy_pmdec","sy_dist","sy_plx","sy_bmag","sy_vmag","sy_jmag","sy_hmag","sy_kmag","sy_umag","sy_gmag","sy_rmag","sy_imag","sy_zmag","sy_w1mag","sy_w2mag","sy_w3mag","sy_w4mag","sy_gaiamag","sy_icmag","sy_tmag","sy_kepmag"
];
...
Promise.all([
    d3.csv("../data/NASA-Export-ALL.csv", d => {
