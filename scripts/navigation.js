    ...
    const navHTML = `
        <nav class="global-navbar">
            ...
            <div class="nav-links-container">
                ...
                <a href="${basePath}${pagesPath}parallel-coordinate-plot.html" class="nav-link" data-path="parallel-coordinate-plot.html">Parallel Coordinates</a>
                
                <div class="nav-dropdown">
                    <button class="nav-dropdown-btn">Spiderplots</button>
                    <div class="nav-dropdown-content">
                        <a href="${basePath}${pagesPath}spiderplot.html" class="nav-link" data-path="spiderplot.html">Compare View</a>
                        <a href="${basePath}${pagesPath}spiderplot-gallery.html" class="nav-link" data-path="spiderplot-gallery.html">Individual Gallery</a>
                    </div>
                </div>

                <a href="${basePath}${pagesPath}scatterplot.html" class="nav-link" data-path="scatterplot.html">Scatterplot</a>
